...
haiti_dom_plot <- # this is the 'base' plot
  ...
  x = "Foreign Direct Investment Net Inflows (US$ per $100 million)",
...
ggsave(filename = "haiti_plot.png", width = 11, height = 8.5)

```

![Broadband Access per 100 People](haiti_plot.png)
...
semiconductors |>
  ...
  labs(
    title = str_wrap("The Lion's Share of CHIPS (Creating Helpful Incentives for the Production of Semiconductors) funding (un) surprisingly goes to chips in 2022"),
