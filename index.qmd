...
semiconductors |>
  ...
  labs(
    title = str_wrap("The Lion's Share of CHIPS funding (un) surprisingly goes to chips in 2022"),
    ...
    y = "Invesment (Dollar Amount - Millions)",
...
semiconductors |>
  ...
  labs(
    ...
    x = "Investment (Dollar Amount - Millions)",
    y = "Jobs Expected (Number of People)",
